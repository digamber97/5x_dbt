...
select CAST(MAX_TOTAL_CASES_PER_MILLION as INT) - CAST(MIN_TOTAL_CASES_PER_MILLION as INT)/2 as cases_number , CAST(pro.TOTAL_REGENCIES as INT) as TOTAL_REGENCIES 
from regencies as cases INNER JOIN "INTERVIEW_DB"."PLAYGROUND_DIGAMBER_KALIVEMULA"."PROVINCES" as pro 
